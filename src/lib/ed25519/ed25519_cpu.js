/* @ts-self-types="./ed25519_cpu.d.ts" */
...
export class BatchResult {
     ...
     */
    best() {
        const ret = wasm.batchresult_best(this.__wbg_ptr);
        return Hit.__wrap(ret);
    }
    /**
     * @returns {number}
     */
    get best_score() {
        const ret = wasm.batchresult_best_score(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * The exact match, if found.
     * @returns {Hit | undefined}
     */
    hit() {
        const ret = wasm.batchresult_hit(this.__wbg_ptr);
        return ret === 0 ? undefined : Hit.__wrap(ret);
    }
}
...
export class Hit {
    ...
    get address() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.hit_address(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
     ...
     */
    get public_key() {
        const ret = wasm.hit_public_key(this.__wbg_ptr);
     ...
     */
    get secret_key() {
        const ret = wasm.hit_secret_key(this.__wbg_ptr);
        var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
        return v1;
    }
 ...
 * @param {string} prefix
 * @param {string} suffix
 * @returns {BatchResult | undefined}
 */
export function run_batch(seeds, batch_size, prefix, suffix) {
    const ptr0 = passArray8ToWasm0(seeds, wasm.__wbindgen_malloc);
    ...
    const ret = wasm.run_batch(ptr0, len0, batch_size, ptr1, len1, ptr2, len2);
    return ret === 0 ? undefined : BatchResult.__wrap(ret);
}
...
const HitFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_hit_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('ed25519_cpu_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
